...
INSERT INTO imagenes(nombre_publico_imagen, nombre_privado_imagen, tipo_imagen) VALUES
('publico.png', 'privado.png', 'png');

INSERT INTO usuarios (cod_rol, documento_usuario, tipo_documento_usuario, nombres_usuario, apellidos_usuario, telefono_usuario, estado_usuario,cod_imagen)
VALUES (1, 1234567890, 1, 'Pepito', 'Eperez', 314000000, 1,1);

INSERT INTO accesos (cod_usuario, correo_acceso, clave_acceso) VALUES
(1, 'melissa.marin@usantoto.edu.co', '19111a32d63d8bd579a2248594b511127b13f9fbf0f8ee5cf6f6baf3ead5c99a25f92d302c4650043c0aefbb1d90a74a8169f063c7a4c0bcb617c81fbd89f046');
