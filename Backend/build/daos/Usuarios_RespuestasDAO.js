...
class UsuariosRespuestasDAO {
    ...
    static ResponderEncuesta(sqlResponderFecha, sqlResponderAbierta, sqlResponderOpcion, sqlModificarEstado, codigoEncuesta, parametrosEncuesta, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield conexionBd_1.default.task((consulta) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield consulta.oneOrNone(sqlModificarEstado, codigoEncuesta);
            })).then((resultado) => {
                res.status(200).json({
    ...
    static validarOpcion(sql, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield conexionBd_1.default.result(sql, parametros)
                .then((resultado) => {
                res.status(200).json(resultado.rows);
