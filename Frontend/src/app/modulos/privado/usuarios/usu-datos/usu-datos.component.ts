...
export class UsuDatosComponent implements OnInit {
  ...
  tipoDocumentos = [
    { nombre: '' },
    { id: 1, nombre: 'Cédula de Ciudadanía', abre: 'C.C' },
    { id: 2, nombre: 'Tarjeta de Identidad', abre: 'T.I' },
    { id: 3, nombre: 'Tarjeta Extranjería', abre: 'T.E' },
    { id: 4, nombre: 'Pasaporte Nacional', abre: 'P.N' },
    { id: 5, nombre: 'Tarjeta Residente', abre: 'T.R' },
    { id: 6, nombre: 'Registro Civil', abre: 'R.C' },
  ];
